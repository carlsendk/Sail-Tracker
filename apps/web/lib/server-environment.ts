 ...
 */
export const parseEnvironmentContents = (
  contents: string,
): Map<string, string> => {
...
const lookupServerEnvironment = buildEnvironmentLookup(
  loadedEnvironment,
 ...
 */
export const getServerEnvironment = (name: string): null | string =>
  lookupServerEnvironment(name);
